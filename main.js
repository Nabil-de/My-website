...
gsap.from('.text', { opacity: 0, duration: 3, delay: 2.3, y: 25, ease: 'expo.out', stagger: .3 })


gsap.from('.my__img', { opacity: 0, duration: 2, delay: 2, x: 60 })

gsap.from('.title', { opacity: 0, duration: 3, delay: 3.2, y: 25, ease: 'expo.out' });

gsap.from('.mail', { opacity: 0, duration: 3, delay: 2.3, y: 25, ease: 'expo.out', stagger: .3 })


gsap.from('.ani', { opacity: 0, duration: 2, delay: 2, x: 60 })
